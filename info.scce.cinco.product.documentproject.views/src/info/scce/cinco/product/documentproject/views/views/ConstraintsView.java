...
import info.scce.cinco.product.documentproject.views.pages.ConstraintsPage;
import info.scce.cinco.product.documentproject.views.utils.MainUtils;

public class ConstraintsView extends MainView<ConstraintsPage> {
		/**
		 * The ID of the view as specified by the extension.
		 */
		public static final String ID = "info.scce.cinco.product.documentproject.views.views.Constraints";
...
//		private IAction showInheritanceInfoAction;
		...
		public ConstraintsView() {
			...
			obsDefinition.put("constraint", Sets.newHashSet(ListenerEvents.ADDED, ListenerEvents.REMOVED, ListenerEvents.CONTENT_CHANGE));
			
			this.obsDefinition = obsDefinition;
			this.genericParameterClass = ConstraintsPage.class;
		}
