...
import info.scce.cinco.product.documentproject.views.pages.TemplatePage;
import info.scce.cinco.product.documentproject.views.provider.TemplateTreeProvider.ViewType;
import info.scce.cinco.product.documentproject.views.utils.MainUtils;

public class TemplateView extends MainView<TemplatePage>{
	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "info.scce.cinco.product.documentproject.views.views.Template";
...
//	private IAction showInheritanceInfoAction;
	...
	public TemplateView() {
		...
		obsDefinition.put("template", Sets.newHashSet(ListenerEvents.ADDED, ListenerEvents.REMOVED, ListenerEvents.CONTENT_CHANGE));
		
		this.obsDefinition = obsDefinition;
		this.genericParameterClass = TemplatePage.class;
	}
