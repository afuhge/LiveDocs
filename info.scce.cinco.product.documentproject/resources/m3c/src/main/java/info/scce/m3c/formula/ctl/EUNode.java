...
public class EUNode extends BinaryFormulaNode {

    public EUNode() {

    }

    public EUNode(FormulaNode leftChild, FormulaNode rightChild) {
    ...
    public <T> T accept(MuCalcNodeVisitor<T> visitor) {
        throw new UnsupportedOperationException("EUNode represents a CTLFormula.");
    }
